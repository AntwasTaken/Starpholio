/*namespace Starpholio.Data {
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Starpholio.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Starpholio.Models.ApplicationDbContext context)
        {
            var categories = new List<Categories> {
                new Categories {ID=1, Nome="Desporto"},
                new Categories {ID=2, Nome="Lazer"},
                new Categories {ID=3, Nome="Cultura"}
             };

            categories.ForEach(aa => context.Categories.AddOrUpdate(a => a.Nome, aa));
